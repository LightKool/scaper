...
from scraperd.utils import get_crawl_args
from scraperd import __version__
...
class Launcher(Service):
	...
	def __init__(self, config, app):
		...
		self.runner = config.get('runner', 'scraperd.runner')
		self.app = app

	def startService(self):
		for slot in range(self.max_proc):
			self._wait_for_project(slot)
		log.msg(format='scraperd %(version)s started: max_proc=%(max_proc)r, runner=%(runner)r',
